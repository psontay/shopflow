...
class UserTest {
    ...
    void testCreateUser_Success() {
        ...
        User user = new User(userId, "john.doe", "john@example.com", "hashedPassword123");
    ...
    void testCreateUser_NullId_ThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> 
            new User(null, "john.doe", "john@example.com", "password")
        );
    }
    ...
    void testChangePassword_Success() {
        User user = new User(UUID.randomUUID(), "john", "john@example.com", "oldPass");
